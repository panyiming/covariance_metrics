...
#all_res_sam = samcov_portfolio(df_rolls, 200, 1260, 21, num_trade)
...
```{r}
num_trade = 190
root_dir = '~/Desktop/courses_term3/Master_project/data/cov_200_dcc/'
all_res_dccnl_12690_100 = dccnl_portfolio(df_rolls, 200, 1260, 21, num_trade, root_dir)
```
